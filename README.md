...
Al momento de crear un usuario, siempre se comienza como usuario normal, y el rol de administrador o colaborador es asignado por nosotros (). 

La tabla _Category_ será usada tanto por los eventos (categoría/s a la cual corresponde el evento, por ejemplo taller, fiesta, etc) como por los usuarios (representa a las preferencias del usuarios, lo que el usuario quiere ver en la aplicación). 
